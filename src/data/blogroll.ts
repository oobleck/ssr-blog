...
export const blogroll: BlogrollItem[] = [
  {
    label: "Ola Englund",
    description:
      "Ola is a Swedish guitarist, producer, and internet personality known for his skills in heavy metal and his extensive online presence.",
    category: ["people"],
    tags: ["heavy metal", "guitar"],
    webpage: [
      "https://invidious.privacyredirect.com/channel/UCfWdGyZaZODBPQc9Lu0y6aw",
      "https://invidious.privacyredirect.com/channel/UCcv_d_n6xibI7YYeXDEX9mg",
    ],
  ...
  },
  {
    ...
    webpage: [
      ...
      "https://front-end.social/@leaverou",
    ],
  ...
  },
  {
    ...
    description:
      "Blog, news, and Youtube channel about Nick's adventure using Linux as his daily driver",
    category: ["tech"],
    tags: ["linux"],
  ...
  },
  {
    label: "Nick",
    description:
      "The blogger/podcaster/tuber/dude behind The Linux Experiment on Mastodon",
